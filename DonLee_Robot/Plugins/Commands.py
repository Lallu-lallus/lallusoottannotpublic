...
async def start(bot, update):
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    'Developers', url="https://t.me/tg_bots_updates"
                                )
                        ]
                    ]
                )
    ...
    buttons = [[
        InlineKeyboardButton('My Dev 🧒', url='https://t.me/pro_editor_tg'),
        ...
        InlineKeyboardButton('Botz disccurssions', url='https://t.me/tg_bots_disccurssions')
    ]]
